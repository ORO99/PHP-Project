...
// var userOptionItem = document.getElementsByClassName("userOption");
var userOptionItem = document.getElementById("user");
document.cookie = "userId=" + userOptionItem.firstElementChild.value.toString();
userOptionItem.addEventListener("change", function(e) {
    document.cookie = "userId=" + e.target.value.toString();
