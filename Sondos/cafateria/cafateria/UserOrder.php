...
<head>
  ...
  <link rel="stylesheet" href="userorder2.css">
...
<body>
  ...
  <nav>
    ...
    <ul>
      <li><a href="..\..\..\Youssef\cafe-login\home.php">LogOut </a></li>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-2 col-md-4 col-sm-12">
        ...
        <form action="UserOrder.php?id=<?php echo $userID; ?>" method="POST">
          <div class="card-body">
    ...
    while($row = mysqli_fetch_array($allUsers)){
      ...
      <option class="userOption" value="<?= $User?>"><?=$User ?></option>
    <?php
    }
    ?>
      ...
      <div class="col-lg-10 col-md-8 col-sm-12">
        ...
        <p class="addToUser">Last Order : </p>
        <div class="order">
